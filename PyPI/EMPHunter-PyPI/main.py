...
def main():
    ...
    cf.read(os.path.join(PROJECT_DIR, "./config.ini"))
    
    datashare_path = os.path.join(PROJECT_DIR, "DataShare/Packages")
    ...
    # ========================for detect=====================================#
        ...
        merge_len = 1660 #1651 #1660  #5847 + 1 # 2839 + 1   #1306 + 1  # 2585 + 1  # 5847 + 1

        with open(os.path.join(PROJECT_DIR, "./DataShare/ApiSeq_and_Result/PreProcess/proj_config.txt"), "w+") as config_file:
